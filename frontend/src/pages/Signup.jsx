            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid gap-2">
                ...
                <div className='relative'>
                  ...
                  />
                  {
                    showPassword ? <EyeOff onClick={()=> setShowPassword(false)} className='w-5 h-5 text-gray-700 absolute right-5 bottom-2'/> : <Eye onClick={()=>setShowPassword(true)} className='w-5 h-5 text-grey-700 absolute right-5 bottom-2'/>
                  }
                </div>
              </div>
            </div>
